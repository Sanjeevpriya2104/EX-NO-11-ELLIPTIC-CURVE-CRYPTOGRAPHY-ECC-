...
int main() {
    ...
    printf("Enter sanjeev's private key: ");
    scanf("%lld", &privateA);
    ...
    printf("sanjeev's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    ...
    printf("Shared secret computed by sanjeev: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
...
## Output:
<img width="1586" height="905" alt="image" src="https://github.com/user-attachments/assets/613f8874-d4b8-427f-bdfc-887fa6dbf101" />
